...
namespace SpriteExporter
{
    public class SpriteExporter
    {
        ...
        {
            string spritePath = "Assets/SpriteExporter/Demo/Animals.png"; //Path to the sliced Sprite Sheet
            Texture2D texture = AssetDatabase.LoadAssetAtPath<Texture2D>(spritePath);
            string outputDirectoryPath = "Assets/SpriteExporter/ExportedSprites/";
